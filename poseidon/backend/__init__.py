...
def create_app():
    ...
    # Enable CORS
    CORS(app, resources={r"/api/*": {"origins": "http://129.21.113.232:3000"}})
    ...
    from .file_route import handle_file as handle_file_blueprint
    ...
    app.register_blueprint(handle_file_blueprint, url_prefix='/api/v1/handle_file')
